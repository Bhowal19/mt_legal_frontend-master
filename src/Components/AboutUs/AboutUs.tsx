        ...
        <div>
                ...
                <div className={`${styles["container"]}`}>
                    <div className="grid items-center grid-cols-2">
                        ...
                        <div className=" h-full px-12 py-8 relative ">
                            ...
                            If you are dreaming of starting a new business but not sure where to begin, the online legal team at MTLegal Team is here to help.
                            <br />
                            <br />
                                Many people have a simple dream of starting a
                                business. Most never make it because they don't
            ...
            <section>
                <div className={`${styles["container"]} relative`}>
                    ...
                    <div className={`${styles["vertical-line"]} bg-white`}></div>
                    <div
                        className={`${LandingStyles["section-header"]} text-bluePrimary`}
                    >
                        Our Core Values
...
<section className="relative">
  <div className={`${styles["vertical-line"]} bg-white`}></div>
  <div className={`${LandingStyles["section-header"]} text-bluePrimary`}>
    Testimonials
  </div>
  <div
    className={`absolute w-1/3 h-5/6 right-0 bg-blue-bg -z-10 ${styles["rounded"]}`}
